...
public class ItemsFactory {
    ...
    //MUNITION
    public static final Item.Munition PISTOL_MUNITION_BOX = new Item.Munition("9mm", 20, "A 9mm munition Box, Perfect for my Beretta");
    public static final Item.Munition SHOTGUN_MUNITION_BOX = new Item.Munition("12mm", 10, "A 12mm Munition Shells box perfect for a Remington");
    ...
    public static final Item.HealingItem RED_HERB = new Item.HealingItem("Red Herbb", 4, "Not as powerful as a green her");
