...
public class WeaponFactory {
   ...
   public static final Weapon KNIFE = new Weapon("Knive", 15, "My old Ka-Bar combat knife, good thing I save it after Fallujah");
   ...
   public static final Weapon SHOTGUN = new Weapon("Shotgun", 100, "A Remington 870 Police Magnum, cal.12 shells");
